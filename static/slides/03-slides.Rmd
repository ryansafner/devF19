...
### [Political Economy & Making Fair Comparisons](#2)

### [Two Trends in "Economic" Thinking](#12)

### [*Marxian* -Socialism](#28)

### [The Socialist Calculation Debate](#39)

### [The Economics of Central Planning](#48)

### [Mises' Critique of Socialism](#57)

### [Neoclassical Market Socialism](#68)

### [The Socialist Calculation Debate: In Retrospect](#78)
...
.pull-right[
.center[
![](https://www.dropbox.com/s/ovgpa7jchye8wil/applesoranges.jpg?raw=1)
]
]
---
...
.center[
![:scale 50%](https://www.dropbox.com/s/w5ecx0628ihm9n2/smith.png?raw=1)
...
.pull-right[
.center[
![:scale 55%](https://www.dropbox.com/s/hptz0oijisiancz/marx.png?raw=1)
...
.left-column[
.center[
![:scale 80%](https://www.dropbox.com/s/mb70osuxubsi4dy/ferguson.png?raw=1)
...
.left-column[
.center[
![:scale 80%](https://www.dropbox.com/s/nngnae748fflox5/hayekelder.png?raw=1)
...
.left-column[
.center[
![:scale 80%](https://www.dropbox.com/s/0fngiqjdhpf2p71/comte.png?raw=1)
...
- .shout[Positivism]: knowledge is derived (only) from quantifiable empirical evidence
...
- .whisper["Scientism"]: understanding and mastering these laws to rationally order a society
...
.pull-left[
.center[
![:scale 100%](https://www.dropbox.com/s/3rxb44kt8uczrxb/utopia.jpg?raw=1)
...
- Science of .shout[public administration]: substitution of democracy and markets with rule by technocratic *experts* insulated from politics

.center[
![:scale 30%](https://www.dropbox.com/s/jokpywlox6qvvzv/roosevelttrusts.png?raw=1)
]
]
...
> "Our epoch, the epoch of the bourgeoisie, possesses, however, this distinct feature: it has simplified class antagonisms. Society as a whole is more and more splitting up into two great hostile camps, into two great classes directly facing each other — **Bourgeoisie** and **Proletariat**," $(\S1$ Bourgeois and Proletarians)
]
]
...
> "In this sense, the theory of the Communists may be summed up in the single sentence: **Abolition of private property,** $(\S2$ Proletarians and Communists)
]
]
...
- Marxian analysis is done through Hegelian .whisper[dialectic]
    - A thesis
    - An antithesis
...
- Marx's .whisper[*materialist* dialectic]
...
- .shout[Allocatively efficient]: goods optimally allocated to highest-valued uses
    - Price equals marginal (opportunity) cost

- .shout[Productively efficient]: goods are produced at the minimum average cost

- .shout[Pareto efficient]: no additional exchanges exist that can make at least one person better off without harming another person
...
# The Economics of Central Planning II

.pull-left[

- .whisper[General equilibrium theory]: study of simultaneous equilibrium across all markets
...
.left-column[
.center[
![:scale 40%](https://www.dropbox.com/s/viqkhpmebwyysre/adolfberle.jpg?raw=1)

Adolf Berle 

(1895-1971)

![:scale 40%](https://www.dropbox.com/s/1dr94mb275hi05k/gardinermeans.jpg?raw=1)
...
- Therefore, .whisper[it is impossible under socialism to rationally allocate productive resources]
...
- This mistakes the .shout[economic problem] for a mere .whisper[technological problem]
...
- .shout[Market Socialism]: maintaining a price system (or importing one) but having the State direct economic activity
]
...
# Isn't This "Socialism" Just Replicating Competitive Markets I
...
# Isn't This "Socialism" Just Replicating Competitive Markets? II
...
.pull-left[
- I am omitting Mises' and (more famously) Hayek's responses to Lange and others
    - We'll see them next week in the next lesson
    - This exchange leads to new insights about the *function of market prices*
...
- **Marxists**: .onfire[rivalry as inherent flaw] in capitalism leading to conflict; central planning removes rivalry and leads to pre-coordinated harmony

- **Mises-Hayek**: .onfire[rivalry] under specific institutions (market prices, property rights) .onfire[is the only way to generate the information] necessary to rationally allocate resources

- **Neoclassical economists**: .onfire[assume rivalry away] in perfect competition models, viewing prices as just parametric statistics, allowing a central planner to achieve the same optimal outcome
...
- What *are* the functions of market prices, competition, equilibrium, etc? 
