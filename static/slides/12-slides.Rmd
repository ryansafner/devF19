---
title: "Lesson 12: Russia and the Post-Communist Transition"
...
### [How Did Soviet "Central Planning" Work?](#39)
### [The Troubled Transition from Communism](#111)
...
- .onfire[Mensheviks]: *urban* socialists
  ...
  - wanted a larger scale, working class, democratic, and more gradual "revolution"
...
.pull-left[
.center[
![:scale 80%](https://www.dropbox.com/s/pceweuk3lkv2juz/sovietpolicies.png?raw=1)
...
.pull-left[
.center[
![:scale 65%](https://www.dropbox.com/s/mn8dyk57terjyru/sovietbreadline.png?raw=1)
]
]
...
> "In an economy of chronic shortages and carefully parceled-out privileges, **blat** is an essential lubricant of life. The more rank and power one has, the more \emph{blat} one normally has...each has access to things or services that are hard to get and that other people want or need."
...
- Not in the interest of shopkeepers or Soviet officials to allow market clearing prices!

- Setting prices low to shortage levels $\bar{P}$ creates a *de facto* property right to allocate scarce desired goods

- Can trade favor of access for other favors to otherwise inaccessible goods
