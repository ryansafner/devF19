...
soviets<-wb(country = c("RU", "UA", "PL", "BY", "TM", "EE"),
...
ggplot(data = .)+
  ...
  scale_x_continuous(breaks=seq(1984,2020,4),
                     limits=c(1984,2020))+
  scale_y_continuous(breaks=seq(-16,16,2),
...
ggplot(data = .)+
  ...
  scale_x_continuous(breaks=seq(1984,2020,4),
                     limits=c(1984,2020))+
  scale_y_continuous(breaks=seq(0,26000,2000),
                                labels=scales::dollar)+
    theme_classic(base_family = "Fira Sans Condensed", base_size=18)+
  labs(x = "Year",
       y = "GDP per Capita (Current USD)",
...
ggplot(data = .)+
  ...
  scale_x_continuous(breaks=seq(1984,2020,4),
                     limits=c(1984,2020))+
  scale_y_continuous(breaks=seq(-24,32,4),
                     labels=function(x){paste(x,"%")})+
    theme_classic(base_family = "Fira Sans Condensed", base_size=18)+
  labs(x = "Year",
