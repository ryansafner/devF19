...
.pull-right[
.center[
![:scale 70%](https://www.dropbox.com/s/negrzf3krvj22no/marshallplan.JPG?raw=1)
]
]
...
.pull-right[
.center[
![:scale 65%](https://www.dropbox.com/s/fv3g7jyp7kesus5/redscare.jpg?raw=1)
]
]
...
.pull-left[
.center[
![:scale 75%](https://www.dropbox.com/s/9eoyiltn2i5b8pd/jfkusaid.jpg?raw=1)
...
.pull-right[
.center[
![:scale 100%](https://www.dropbox.com/s/in5lghv27mcg2a6/tradebarriers.jpg?raw=1)
]
]
...
.pull-left[
.center[
![](https://www.dropbox.com/s/4xx91co8mn61jgc/latinamerica.png?raw=1)
]
]
...
.pull-right[
.center[
![:scale 100%](https://www.dropbox.com/s/msc67onhcf0ntyr/imfbuilding.jpg?raw=1)
]
]
...
.center[
![](https://www.dropbox.com/s/ll6q5v907lui8ui/imfcartoon.jpg?raw=1)
]
...
.center[
![:scale 80%](https://www.dropbox.com/s/8mwmr16785brmap/countriesrecipients.jpg?raw=1)
]
...
.pull-right[
.center[
![](https://www.dropbox.com/s/5ofyfn5l2fl18dx/povertytrap.jpg?raw=1)
]
]
...
.center[
![:scale 40%](https://www.dropbox.com/s/4g62w5rsa0pk2m6/aid1.png?raw=1)
]
...
.center[
![:scale 50%](https://www.dropbox.com/s/hqfl5vj9v1ebcqh/aid2.png?raw=1)
]
...
.left-column[
.center[
![:scale 80%](https://www.dropbox.com/s/psiu7eyw4o7x7iu/sachs.png?raw=1)
...
.pull-left[
.center[
![:scale 60%](https://www.dropbox.com/s/g3dd79jkf5ic2ej/endofpoverty.jpg?raw=1)
]
]

.pull-right[
.center[
![:scale 50%](https://www.dropbox.com/s/ynzvuesd7xbmuov/munkidealist.jpg?raw=1)
]
]
...
.center[
![](https://www.dropbox.com/s/o1iamj1l95zrkl0/sachsbono.png?raw=1)
]
...
- .shout[Linear regression] is the process of fitting a line to data
...
- If you want to know more, take my [econometrics class](http://metricsf19.classes.ryansafner.com)
...
- A lot of variables used are .onfire[proxy] variables that are correlated with something we care about, but can't measure
    - Inflation rate
...
.pull-right[
.center[
![](https://www.dropbox.com/s/rhsxxmoyd1m29i0/streetlampeffect.jpeg?raw=1)
]
]
...
.center[
![:scale 55%](https://www.dropbox.com/s/qod3lyt5ayj63pw/kitchensinkgrowthreg.png?raw=1)
...
$$\text{GDP per capita growth} = \beta_0 + \beta_1 \text{Initial GDP} + \beta_2 + \text{Ethnic fractionalization} + \beta_3 \text{Assassinations} + \cdots$$
...
.pull-left[
.center[
![:scale 70%](https://www.dropbox.com/s/9kbl4fcwyqhn5us/burnsidereg1.png?raw=1)
]
]
...
.pull-left[
.center[
![:scale 70%](https://www.dropbox.com/s/znr1y4y1gazaoeb/burnsidereg2.png?raw=1)
]
]
...
# Easterly, Levine, and Roodman (2003): Comment on Burnside and Dollar (2000) I
...
# Easterly, Levine, and Roodman (2003): Comment on Burnside and Dollar (2000) II

.center[
![:scale 40%](https://www.dropbox.com/s/2i3gwilkkzl9bhl/easterlyondollar.png?raw=1)
]
...
.center[
![:scale 80%](https://www.dropbox.com/s/6q66nhcl3jz16la/ovaskaaid.png?raw=1)
]
...
.center[
![](https://www.dropbox.com/s/x9srssjzduzs8qp/foreignaidcartoon.png?raw=1)
]
...
.pull-right[
.center[
![](https://www.dropbox.com/s/neahyesy2igtcmc/fakegrowth.jpg?raw=1)
]
