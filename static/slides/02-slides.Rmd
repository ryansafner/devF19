...
### [Development as Freedom](#67)

### [Poverty and Basic Human Needs](#82)
...
.center[
![:scale 60%](https://www.dropbox.com/s/hzdt8ey3dppq0zs/hdimap.png?raw=1)

![:scale 40%](https://www.dropbox.com/s/tt60r92e80opo20/hdimapscale.png?raw=1)
]

.source[Source: [Wikipedia](https://en.wikipedia.org/wiki/Human_Development_Index#/media/File:2018_HDI.svg), 2017 data]
...
.center[
![:scale 62%](https://www.dropbox.com/s/o3nqe6771knacwb/human-development-index-escosura.png?raw=1)
]

.source[Source: [Our World in Data: Human Development Index](https://ourworldindata.org/human-development-index)]
...
.center[
![:scale 62%](https://www.dropbox.com/s/1r13rwo0fnwdjxj/hdi-vs-gdp-per-capita.png?raw=1)
]
...
.center[
![:scale 62%](https://www.dropbox.com/s/bkqtnuku1seduvy/economic-inequality-gini-index.png?raw=1)
]
...
- [gapminder.org](http://gapminder.org/tools/): amazing visualizations between countries and over time
