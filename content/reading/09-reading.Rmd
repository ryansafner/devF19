...
We pretty much know what policies and institutions generate prosperity (property rights, rule of law, etc). Leaders of developing countries know this as well. Why don't they implement them? Or, more accurately, what would happen if they implement them? 
...
What is the difference between a natural state (or limited access order) and an open access order (in North, Wallis, and Weingast's model)? How does one become the other? Which societies today look like which form? 
For what rational reasons do groups within countries (or countries themselves) go to war when bargaining is cheaper? How do societies minimize this risk? 
